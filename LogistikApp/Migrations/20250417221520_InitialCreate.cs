    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NoResi = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shipments", x => x.NoResi);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShipmentNoResi = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Weight = table.Column<double>(type: "float", nullable: false),
                    Dimension = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Packages", x => x.ShipmentNoResi);
                    table.ForeignKey(
                        name: "FK_Packages_Shipments_ShipmentNoResi",
                        column: x => x.ShipmentNoResi,
                        principalTable: "Shipments",
                        principalColumn: "NoResi",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recipients", x => x.ShipmentNoResi);
                    table.ForeignKey(
                        name: "FK_Recipients_Shipments_ShipmentNoResi",
                        column: x => x.ShipmentNoResi,
                        principalTable: "Shipments",
                        principalColumn: "NoResi",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Senders", x => x.ShipmentNoResi);
                    table.ForeignKey(
                        name: "FK_Senders_Shipments_ShipmentNoResi",
                        column: x => x.ShipmentNoResi,
                        principalTable: "Shipments",
                        principalColumn: "NoResi",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShipmentStatusHistory_Shipments_ShipmentNoResi",
                        column: x => x.ShipmentNoResi,
                        principalTable: "Shipments",
                        principalColumn: "NoResi",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentStatusHistory_ShipmentNoResi",
                table: "ShipmentStatusHistory",
                column: "ShipmentNoResi");
        }
